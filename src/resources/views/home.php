...
<html>
  <head>
    <title>NeoFiddle</title>
    <link rel="stylesheet" type="text/css" href="/style">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    
  <meta property="og:title" content="NeoFiddle">
  ...
  <body>
    <div class="navbar">
    	<h1 style="margin-bottom:0;margin-top:.5rem;font-size:2.5rem;"><i style="color:#de2c09;" class="fa-solid fa-meteor"></i> <b>Neo</b><a class="fire">Fiddle</a></h1>
