...
<body>
    ...
    <small class="d-inline-flex mb-3 justify-content-start align-items-end position-fixed bottom-0 start-0 px-2 py-1 fw-semibold text-success-emphasis bg-success-subtle border border-success-subtle rounded-2 ms-3">Fiddle v0.0.0</small>
    <small class="d-inline-flex mb-3 justify-content-end align-items-end position-fixed bottom-0 start-0 px-2 py-1 fw-semibold text-success-emphasis bg-success-subtle border border-success-subtle rounded-2 ms-3">Created by zulujive</small>
