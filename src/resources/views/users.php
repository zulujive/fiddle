...
<body>
    ...
    <br>
    <form class="container card bg-dark text-white shadow w-25" method="post" action="/admin/register">
        <br>
        ...
        <button class="btn btn-light shadow mt-3 mb-3 w-50 p-3" type="submit" value="submit">Register</button>
    </form>
