...
$cspHeader = "default-src 'self'; script-src 'self' '$bootstrapScriptHash'; style-src https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css $bootstrapStyleHash 'self' 'unsafe-inline'; img-src 'self'; font-src https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/webfonts/*.woff2 'self' 'unsafe-inline'";
